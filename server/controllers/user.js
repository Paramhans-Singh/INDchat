...
// api to authenticate the new user for sign up 
...
// api to authenticate the user for log-in
export const login = async (req, res) => {
  ...
  try {
    ...
    // matches the hidden password to orignal
...
// api to authenticate user by google auth
...
// api to get the user from the database
...
// api to update the user details in the database
